...
//                                setTimeout(jQuery.magnificPopup.close(), 1000);
    ...
    if ($user_index !== false) {
        ...
        $userEmail = $users[$user_index]['email'];
    }
    ?>
    <div style="text-align:center;" id="sr-popup2" class="zoom-anim-dialog">
        <div id="container">
            ...
            <div class="row margin-top-30">
                <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8"><input class="form-control" type="text"
                                                              value="<?php echo $userName; ?>" id="sr-name"/></div>
                    </div>
                    <div class="row margin-top-5">
                        <div class="col-md-4 col-sm-4"><label for="sr-name">Email:</label></div>
                        <div class="col-md-8 col-sm-8"><input class="form-control" value="<?php echo $userEmail; ?>"
            ...
            <p>Not enough options? <a href="<?php echo home_url(); ?>/sr-alerts" target="_parent">Click here</a> to
